...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Orders || Car and Bike Shop</title>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <!-- Right Nav Section -->
        <ul class="right">
          ...
          <li class="active"><a href="../View/orders.php">My Orders</a></li>
          ...
          if(isset($_SESSION['username'])){
            ...
            echo '<li><a href="../contr/login.php">Log In</a></li>';
            echo '<li><a href="../contr/register.php">Register</a></li>';
          }
          ?>
        </ul>
      </section>
